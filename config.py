...
cam_config = {
    "cam_left": {
        ...
        "E_0": np.mat([
            [0.0265686, -0.999625, -0.00665175, -0.131281],
            [0.0841975, 0.0088682, -0.99641, 0.106948],
            [0.996095, 0.0259131, 0.0844015, -0.213647],
            [0, 0, 0, 1]
        ])},
